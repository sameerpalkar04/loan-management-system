...
import OfficerConsolePage from "../pages/officer/OfficerConsolePage";
...
export default function AppRoutes() {
  return <Routes>
    ...
    <Route path="/officer/dashboard" element={<ProtectedRoute role="LOAN_OFFICER"><OfficerConsolePage /></ProtectedRoute>} />
    ...
    <Route path="/preview/officer/dashboard" element={<OfficerConsolePage />} />
