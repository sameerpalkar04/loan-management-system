...
export const createLoanApplication = (application, panCardImage) => {
  ...
  return apiRequest("/api/v1/loan-applications", { method: "POST", body: formData });
};
...
export const updateApplicationStatus = (applicationId, status) => apiRequest(`/api/v1/loan-applications/${applicationId}/status`, { method: "PATCH", body: JSON.stringify(status) });
